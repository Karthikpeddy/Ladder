...
export default function Services() {
  const services = [
    ...
    },
    {
      ...
      description: "Strategic digital solutions that accelerate your business growth exponentially."
    },
    {
      icon: <BarChart size={24} />,
      title: "Analytics & SEO",
      description: "Data-driven optimization to increase your online visibility and performance."
    }
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            We provide end-to-end digital solutions to help your business reach new heights.
          </p>
        </div>
